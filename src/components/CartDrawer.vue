                  ...
                  <div class="flex h-full flex-col overflow-y-auto bg-white shadow-xl">
                    <div class="flex-1 overflow-y-auto px-4 py-6 sm:px-6">
                      <div class="flex items-start justify-between">
                        ...
                        <DialogTitle class="text-lg font-medium text-gray-900 flex gap 2 items-center">

                          <img :src="logo" class="h-8" alt="KATLOG logo">
                        </DialogTitle>
                        <div class="ml-3 flex h-7 items-center">
                          <button type="button" class="relative -m-2 p-2 text-gray-400 hover:text-gray-500" @click="emitClose">
                            ...
                            <li v-for="product in products" :key="product.id" class="flex py-6">
                              ...
                              <div class="ml-4 flex flex-1 flex-col">
                                ...
                                <div class="flex flex-1 items-end justify-between text-sm">
                                  ...
                                  <div class="flex">
                                    <button type="button" class="font-medium text-green-700 hover:text-green-800">Remove</button>
                                  </div>
                                </div>
                              </div>
                            </li>
                    ...
                    <div class="border-t border-gray-200 px-4 py-6 sm:px-6">
                      ...
                      <div class="mt-6">
                        <a href="#" class="flex items-center justify-center rounded-md border border-transparent bg-green-700 px-6 py-3 text-base font-medium text-white shadow-xs hover:bg-green-800">Checkout</a>
                      </div>
                      <div class="mt-6 flex justify-center text-center text-sm text-gray-500">
                        <p>
                          or{{ ' ' }}
                          <button type="button" class="font-medium text-green-700 hover:text-green-800" @click="emitClose">
                            Continue Shopping
